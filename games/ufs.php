        ...
        <div id="content-container">
            ...
            <div id="content">
                <div class="window">
                    <div class="window-titlebar">
                        <div class="window-titlebar-text">
                            Ultimate Flash Sonic <!--&bull; <a class="window-titlebar-text" href="games/winrg.php">Play</a>-->
                            <div class="gallery-date">
                    ...
                    <div class="window-content-padding">
                        <center><span><embed src="../flash/ufs.swf" width="370" height="269"></embed></span></center>
                    </div>
                </div>
            </div>
            <!-- end content -->
